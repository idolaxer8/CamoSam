...
class OurModelEmb(nn.Module):
    def __init__(self, args):
        super(OurModelEmb, self).__init__()
        self.backbone = OurEncoder()
...
if __name__ == "__main__":
    ...
    # sam_args = {
    #     'sam_checkpoint': "/home/tal/MedicalSam/cp/sam_vit_h.pth",
    #     'model_type': "vit_h",
    #     'generator_args': {
    #         'points_per_side': 8,
